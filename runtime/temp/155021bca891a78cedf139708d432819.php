<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:65:"F:\phpStudy\WWW\public/../application/admin\view\admins\edit.html";i:1536992691;s:55:"F:\phpStudy\WWW\application\admin\view\layout\base.html";i:1539760980;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
...
<div class="header"><h1 class="page-title">修改 管理员信息</h1></div>

<ul class="breadcrumb">
    <li><a href="index.html">主页</a> <span class="divider">/</span></li>
    <li><a href="users.html">管理员列表</a> <span class="divider">/</span></li>
    ...
    <div class="row-fluid">
        ...
        <div class="well">
            ...
            <div id="myTabContent" class="tab-content">
                ...
                <form id="tab" action="/admin/admins" method="post">
                    <!-- 添加表单隐藏控件，用于保存当前管理员的ID号 -->
                    <input type="hidden" name="id" value="<?php echo $res->aid; ?>">

                    <label>用户名</label>
                    <input type="text" name="aname" required="required" class="input-xlarge" value="<?php echo $res->aname; ?>">
                    <label>密码</label>
                    <input type="text" name="apwd" required="required" class="input-xlarge" value="<?php echo $res->apwd; ?>">
                    <label>权限等级</label>
                    <div class="input-prepend">
                        <label class="radio inline">
                            <input type="radio" name="alevel" value="1" <?php if ($res->alevel == 1) echo 'checked'; ?>>高级管理员</label>
                        <label class="radio inline">
                            <input type="radio" name="alevel" value="2" <?php if ($res->alevel == 2) echo 'checked'; ?>>初级管理员</label>
                    </div>
                </form>
                </div>
            </div>
