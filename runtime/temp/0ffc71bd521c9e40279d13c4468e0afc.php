<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:65:"F:\phpStudy\WWW\public/../application/admin\view\banner\edit.html";i:1538153292;s:55:"F:\phpStudy\WWW\application\admin\view\layout\base.html";i:1542423402;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
...
<div class="header"><h1 class="page-title">修改 广告图</h1></div>

<ul class="breadcrumb">
    <li><a href="index.html">主页</a> <span class="divider">/</span></li>
    <li><a href="users.html">广告图列表</a> <span class="divider">/</span></li>
    <li class="active">修改广告图</li>
</ul>
    ...
    <div class="row-fluid">
        ...
        <div class="well">
            <ul class="nav nav-tabs">
              <li class="active"><a href="#home" data-toggle="tab">广告图信息</a></li>
            </ul>
            <div id="myTabContent" class="tab-content">
                <div class="tab-pane active in" id="home">
                <form id="tab" action="/admin/banner" method="post" enctype="multipart/form-data">
					<!-- 添加表单隐藏控件，用于绑定banner图片ID，作为数据更新条件 -->
                    <input type="hidden" name="bid" value="<?php echo $ban->bid; ?>">

                    <label>广告图片</label>
                    <input id="lefile" type="file" name="bpic" style="display:none">
                    <!-- 创建隐藏控件，用于获取保存原图片路径 -->
                    <input type="hidden" name="bimg" value="<?php echo $ban->bpic; ?>">
                    <div class="input-append">
                        <input id="photoCover" class="input-large" type="text" value="<?php echo $ban->bpic; ?>" disabled>
                        <a class="btn btn-info" onclick="$('input[id=lefile]').click();"><i class="icon-folder-open"></i> 选择文件</a>
                        <img src="<?php echo $ban->bpic; ?>" style="width: 18%; border:1px solid red; position: absolute; margin-left: 10px;">
                    </div>
                    <!-- 给选择文件按钮绑定文件上传事件 -->
                    <script type="text/javascript">
                    ...
                    <label>页面跳转地址</label>
                    <input type="text" name="burl" class="input-xlarge" value="<?php echo $ban->burl; ?>">
                    <label>图片序号</label>
                    <input type="text" name="border" class="input-xlarge" value="<?php echo $ban->border; ?>">
                </form>
                </div>
            </div>
        </div>
