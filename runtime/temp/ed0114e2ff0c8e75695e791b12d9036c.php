<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:64:"F:\phpStudy\WWW\public/../application/admin\view\news\index.html";i:1537002010;s:55:"F:\phpStudy\WWW\application\admin\view\layout\base.html";i:1542423402;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
...
<div class="header"><h1 class="page-title">新闻列表</h1></div>
...
<div class="container-fluid">
    <div class="row-fluid">
        ...
        <div class="btn-toolbar">
            <!-- 绑定页面跳转事件 -->
            <button class="btn btn-primary" onclick="jump()"><i class="icon-plus"></i> 添加新闻</button>
            ...
            <table class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                        <a href="<?php echo url('admin/News/view',['type'=>'edit','id' => $vo['nid']]); ?>"><i class="icon-pencil" title="编辑"></i></a>
                    ...
                    <script type="text/javascript">
                        ...
                        function del() {
                            window.location.href='<?php echo url('admin/News/delete', ['id' => $vo['nid']]); ?>';
                        }
                    </script>
        ...
        <div class="modal small hide fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                <p class="error-text"><i class="icon-warning-sign modal-icon"></i>你确定你要删除这条新闻吗?</p>
            </div>
...
<script type="text/javascript">
    // 添加商品
    function jump(){
        window.location.href='<?php echo url('admin/News/view',['type'=>'insert']); ?>';
    }
</script>
