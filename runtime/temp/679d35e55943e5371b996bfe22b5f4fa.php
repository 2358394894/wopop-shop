<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"F:\phpStudy\WWW\public/../application/admin\view\admins\index.html";i:1536994186;s:55:"F:\phpStudy\WWW\application\admin\view\layout\base.html";i:1539760980;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
            ...
            <table class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                        <?php switch($vo['alevel']): case "1": ?>高级<?php break; case "2": ?>初级<?php break; default: ?>未定义
                        <?php endswitch; ?>
                        </td>
                        <td>
                        <a href="<?php echo url('admin/Admins/view', ['type' => 'edit', 'id' => $vo['aid']]); ?>"><i class="icon-pencil"></i></a>
                    ...
                    <script type="text/javascript">
                        ...
                        function del() {
                            window.location.href = '<?php echo url('admin/Admins/delete',['id' => $vo['aid']]); ?>';
                        }
                    </script>
...
<script type="text/javascript">
    function jump(){
        window.location.href='<?php echo url('admin/Admins/view',['type'=>'insert']); ?>';
    }
</script>
