<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"F:\phpStudy\WWW\public/../application/admin\view\banner\insert.html";i:1538146476;s:55:"F:\phpStudy\WWW\application\admin\view\layout\base.html";i:1542423402;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
        ...
        <div class="well">
            ...
            <div id="myTabContent" class="tab-content">
                ...
                <form id="tab" action="/admin/banner" method="post" enctype="multipart/form-data">
                    ...
                    <label>页面跳转地址</label>
                    <input type="text" name="burl" class="input-xlarge">
                    <label>图片序号</label>
                    <input type="text" name="border" class="input-xlarge">
                </form>
                </div>
            </div>
        </div>
