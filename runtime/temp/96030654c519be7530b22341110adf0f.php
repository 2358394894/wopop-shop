<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:66:"F:\phpStudy\WWW\public/../application/admin\view\banner\index.html";i:1539758417;s:55:"F:\phpStudy\WWW\application\admin\view\layout\base.html";i:1542423402;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
            ...
            <table class="table table-striped table-bordered table-hover">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><img src="<?php echo $vo['bpic']; ?>" alt=""></td>
                        <td><?php echo $vo['burl']; ?></td>
                        <td><?php echo $vo['border']; ?></td>
                        <td>
                        <a href="<?php echo url('admin/Banner/view',['type'=>'edit','id' => $vo['bid']]); ?>"><i class="icon-pencil" title="编辑"></i></a>
                    ...
                    <script type="text/javascript">
                        ...
                        function del() {
                            window.location.href='<?php echo url('admin/Banner/delete', ['id' => $vo['bid']]); ?>';
                        }
                    </script>
...
<script type="text/javascript">
    // 添加商品
    function jump(){
        window.location.href='<?php echo url('admin/Banner/view',['type'=>'insert']); ?>';
    }
</script>
