<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:69:"F:\phpStudy\WWW\public/../application/admin\view\category\insert.html";i:1536547566;s:55:"F:\phpStudy\WWW\application\admin\view\layout\base.html";i:1542423402;}*/ ?>
<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
...
<div class="header"><h1 class="page-title">添加 品牌信息</h1></div>

<ul class="breadcrumb">
    <li><a href="index.html">主页</a> <span class="divider">/</span></li>
    <li><a href="users.html">品牌列表</a> <span class="divider">/</span></li>
    ...
    <div class="row-fluid">
        ...
        <div class="well">
            ...
            <div id="myTabContent" class="tab-content">
                ...
                <form id="tab" action="/admin/category" method="post">
                    <!-- 添加表单隐藏控件，用于修改表单提交方式 -->
                    <input type="hidden" name="_method" value="PUT">

                    <label>品牌名称</label>
                    <input type="text" name="cname" class="input-xlarge">
                </form>
                </div>
            </div>
        </div>
